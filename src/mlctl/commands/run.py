...
@click.option(
    ...
    is_flag=True,
    default=True,
    help='Run in local mode (default)'
)
@click.option(
    '--docker',
    is_flag=True,
    help='Use Docker-based SageMaker local mode'
)
@click.option(
    '--org-config',
...
def run(project_dir: str, local: bool, docker: bool, org_config: str):
    ...
    if metrics_file.exists():
        ...
        console.print("[yellow]Warning: metrics.json not found in evaluation output[/yellow]")
