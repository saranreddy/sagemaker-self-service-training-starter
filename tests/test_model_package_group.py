...
def test_ensure_model_package_group_exists(pipeline_builder):
    ...
    stubber.add_response(
        'describe_model_package_group',
        {
            ...
            'ModelPackageGroupArn': 'arn:aws:sagemaker:us-east-1:123456789012:model-package-group/test-project-models',
...
def test_ensure_model_package_group_validation_exception_does_not_exist(pipeline_builder):
    ...
    stubber.add_client_error(
        ...
        service_message='ModelPackageGroup arn:aws:sagemaker:us-east-1:123456789012:model-package-group/test-project-models does not exist.',
    )
...
def test_ensure_model_package_group_validation_exception_other_message_raises(pipeline_builder):
